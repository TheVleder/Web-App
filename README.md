La aplicación que se presenta es una completa solución para la gestión de tareas básicas en un restaurante o bar. Con esta aplicación, se podrán llevar a cabo diversas acciones que permitirán agilizar y organizar las operaciones diarias de un restaurante. A continuación, se detallan algunas de las características principales:
